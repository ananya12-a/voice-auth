...
# np.random.seed(123)
# random.seed(123)
mfcc_001 = sample_from_mfcc(read_mfcc('data/va-samples/1/enroll.wav', SAMPLE_RATE), NUM_FRAMES)
mfcc_002 = sample_from_mfcc(read_mfcc('data/va-samples/1/sample.wav', SAMPLE_RATE), NUM_FRAMES)
...
mfcc_003 = sample_from_mfcc(read_mfcc('data/va-samples/2/enroll.wav', SAMPLE_RATE), NUM_FRAMES)
